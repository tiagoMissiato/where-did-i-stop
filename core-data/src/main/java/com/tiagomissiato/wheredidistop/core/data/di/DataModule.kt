...
class FakeMovieListRepository @Inject constructor() : MovieListRepository {
    override val movieLists: Flow<List<String>> = flowOf(fakeMovieLists)
...
val fakeMovieLists = listOf("One", "Two", "Three")
