...
import com.tiagomissiato.wheredidistop.movie.data.mock.popularMovieList
import com.tiagomissiato.wheredidistop.movie.data.model.Movie
import com.tiagomissiato.wheredidistop.movie.data.model.toVo
    ...
    Box(Modifier.pullRefresh(pullToRefresh)) {
        Column {
            LazyColumn(
                ...
                items(items) { movie ->
                    CardMovieItem(movie = movie.toVo())
                }
            }
